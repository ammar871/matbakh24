...
class BodyHomeDriver extends StatelessWidget {
  var _orderProvider;
  @override
  Widget build(BuildContext context) {
    if(_orderProvider==null){
      ...
      WidgetsBinding.instance?.addPostFrameCallback((_){
        _orderProvider.getDriverOrders(context: context);
      });    }
    return ListView(
      shrinkWrap: true,
      children: [
        BarProvider(
          KGreenColor,
          Colors.black,
          text1: "${tr("اهلا بك :")} ${currentUser.driver.fullName}",
          text2: "",
          isfound: false,
        ),
        SizedBox(
        ...
        Padding(
          ...
          child: RefreshIndicator(
            onRefresh: () async {
              return    await _orderProvider.getDriverOrders(context: context);
